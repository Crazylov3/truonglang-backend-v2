...
# For development, if database is not available, use a placeholder URL for offline migrations
try:
    config.set_main_option("sqlalchemy.url", sync_database_url)
except Exception:
    # Fallback URL for offline migrations when database is not available
